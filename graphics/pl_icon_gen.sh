...
file="$mydir/plcomms_splash_white.png"
export_png_files "plcomms_splash_white.png" 108

file="$mydir/plcomms_logo_orig.png"
export_png_files "plcomms_logo_orig.png" 108
...
convert "$mydir/plcomms_feature_image.png" -resize "1024x500" "$mydir/../fastlane/metadata/android/en-US/images/featureGraphic.png"
...
file="$mydir/plcomms_splash_white.png"
export_png_files "plcomms_splash_white.png" 72

file="$mydir/ic_notification.png"
export_png_files "ic_notification.png" 24

file="$mydir/plcomms_logo_orig.png"
export_png_files "plcomms_logo_orig.png" 72
...
file="$mydir/ic_splash_pl_vs_vpn.png"
export_png_files "ic_splash_conversations.webp" 300 208
export_png_files "ic_splash_conversations_dark.webp" 300 208

file="$mydir/ic_splash_pl_vs_open_internet.png"
export_png_files "ic_splash_collaboration.webp" 300 208
export_png_files "ic_splash_collaboration_dark.webp" 300 208
